...
import { ListboxFindUniqueArgs } from "./ListboxFindUniqueArgs";
...
export class ListboxResolverBase {
  ...
  async _listboxesMeta(
    @graphql.Args() args: ListboxFindManyArgs
  ...
  async listbox(
    @graphql.Args() args: ListboxFindUniqueArgs,
    @gqlUserRoles.UserRoles() userRoles: string[]
  ...
  async documentListbox(
    ...
    const results = await this.service.findDocumentListbox(parent.id, args);
